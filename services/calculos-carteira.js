...
export function enriquecerListaAtivos(listaAtivosOriginal, mapaCotacoes) {
    return listaAtivosOriginal.map((ativoOriginal) => {
        ...
        const diferencaPrecoTeto = calcularDiferencaParaPrecoTeto(precoAtual, converterParaNumeroSeguro(ativoOriginal.precoTeto, 0));
